...
$(document).ready(function () {
  ...
  $(document).on('click', '.products-paginate', function (event) {
    ...
    $.ajax({
      ...
      $('.instructions').hide();
      $('.product-data').html(data).show(); // fitContent();
...
function getArrayParameters(key) {
...
/***/ 1:
/*!***********************************************************************************************************************************************************************************************************!*\
  !*** multi ./src/js/main-products.js ./src/js/modules/hamburger-menu.js ./src/js/modules/product-search.js ./src/js/modules/product-detail.js ./src/js/modules/plukkliste.js ./src/js/modules/tabbing.js ***!
  \***********************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/******/ });
//# sourceMappingURL=main-products.js.map