...
__webpack_require__(/*! loading-attribute-polyfill */ "./node_modules/loading-attribute-polyfill/loading-attribute-polyfill.min.js");
...
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!function (e) {
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : undefined;
}(function () {
  var e = Object.assign || __webpack_provided_window_dot_jQuery && jQuery.extend,
      t = 8,
  ...
  function m(e, t, n, o, i) {
    ...
    for (; r--;) {
      (c[a = t[r]] || (c[a] = [])).push([n, m]), e.addEventListener(a, m);
    }
  }
  ...
  function f(e, t, n, o) {
    ...
    var i,
        ...
        m = t.length;
    if (r) for (; m--;) {
      if (a = r[i = t[m]]) for (c = a.length; c--;) {
        a[c][0] === n && (e.removeEventListener(i, a[c][1]), a.splice(c, 1));
      }
    }
  }
  ...
  function y() {
    f(document, i.move, X), f(document, i.cancel, Y);
  }
  ...
  function b(e, n, o, i) {
    var a = o.pageX - n.pageX,
        u = o.pageY - n.pageY;
    a * a + u * u < t * t || function (e, t, n, o, i, a) {
      var u = e.targetTouches,
        ...
        enableMove: function enableMove() {
          this.moveEnabled = !0, this.enableMove = l, e.preventDefault();
        }
      };
  ...
  function E(e, t) {
    var n = t.target,
        o = t.event,
        a = t.timer;
    f(document, i.move, T), f(document, i.end, E), k(n, o, a, function () {
      setTimeout(function () {
        f(n, "click", p);
      }, 0);
    });
  ...
  function S(e, t) {
    var n = t.target,
        o = t.event,
        i = t.timer;
    g(e.changedTouches, o.identifier) && (!function (e) {
      f(document, a.move, e.activeTouchmove), f(document, a.end, e.activeTouchend);
    }(t), k(n, o, i));
  }

  function k(e, t, n, o) {
    n.end(function () {
      return v(e, "moveend", t), o && o();
    });
  }
  ...
  if (m(document, "mousedown", function (e) {
    ...
    }(e) || (m(document, i.move, X, e), m(document, i.cancel, Y, e)));
    ...
    if (!o[e.target.tagName.toLowerCase()]) {
      var t = e.changedTouches[0],
        ...
        touchend: function touchend(e, t) {
          !function (e, t) {
            g(e.changedTouches, t.identifier) && w(t);
          }(e, t);
        }
      };
    ...
    if (!e.defaultPrevented && e.moveEnabled) {
      var t = {
        ...
        timer: new s(function (e) {
          ...
          })(t, n.touch, n.timeStamp), v(n.target, "move", t);
        }),
        touch: void 0,
        timeStamp: e.timeStamp
      };
      void 0 === e.identifier ? (m(e.target, "click", p), m(document, i.move, T, n), m(document, i.end, E, n)) : (n.activeTouchmove = function (e, t) {
        !function (e, t) {
          var n = t.event,
              o = t.timer,
              i = h(e, n);
        ...
        S(e, t);
      }, m(document, a.move, n.activeTouchmove, n), m(document, a.end, n.activeTouchend, n));
    }
...
/* WEBPACK VAR INJECTION */(function($) {!function (e) {
  e.fn.beforeafter = function (t) {
    ...
    return this.each(function () {
      var a = t.default_offset_pct,
          o = e(this),
          r = t.orientation,
          i = "vertical" === r ? "down" : "left",
          n = "vertical" === r ? "up" : "right";

      if (o.wrap("<div class='beforeafter-wrapper beforeafter-" + r + "'></div>"), !t.no_overlay) {
        o.append("<div class='beforeafter-overlay'></div>");
        var f = o.find(".beforeafter-overlay");
        f.append("<div class='beforeafter-before-label' data-content='" + t.before_label + "'></div>"), f.append("<div class='beforeafter-after-label' data-content='" + t.after_label + "'></div>");
      }

      var s = o.find("img:first"),
          c = o.find("img:last");
      o.append("<div class='beforeafter-handle'></div>");
      var l = o.find(".beforeafter-handle");
      l.append("<span class='beforeafter-" + i + "-arrow'></span>"), l.append("<span class='beforeafter-" + n + "-arrow'></span>"), o.addClass("beforeafter-container"), s.addClass("beforeafter-before"), c.addClass("beforeafter-after");

      var d = function d(e) {
        var t,
            a,
            i,
            n = (t = e, a = s.width(), i = s.height(), {
          w: a + "px",
          h: i + "px",
          cw: t * a + "px",
          ch: t * i + "px"
        });
        l.css("vertical" === r ? "top" : "left", "vertical" === r ? n.ch : n.cw), function (e) {
          "vertical" === r ? (s.css("clip", "rect(0," + e.w + "," + e.ch + ",0)"), c.css("clip", "rect(" + e.ch + "," + e.w + "," + e.h + ",0)")) : (s.css("clip", "rect(0," + e.cw + "," + e.h + ",0)"), c.css("clip", "rect(0," + e.w + "," + e.h + "," + e.cw + ")")), o.css("height", e.h);
        }(n);
      },
          v = function v(e, t) {
        var a, o, i;
        return a = "vertical" === r ? (t - h) / b : (e - p) / u, o = 0, i = 1, Math.max(o, Math.min(i, a));
      };

      e(window).on("resize.beforeafter", function (e) {
        d(a);
      });
      ...
      var p = 0,
          ...
          b = 0,
          _ = function _(e) {
        (e.distX > e.distY && e.distX < -e.distY || e.distX < e.distY && e.distX > -e.distY) && "vertical" !== r ? e.preventDefault() : (e.distX < e.distY && e.distX < -e.distY || e.distX > e.distY && e.distX > -e.distY) && "vertical" === r && e.preventDefault(), o.addClass("active"), p = o.offset().left, h = o.offset().top, u = s.width(), b = s.height();
      },
          w = function w(e) {
        o.hasClass("active") && (a = v(e.pageX, e.pageY), d(a));
      },
          m = function m() {
        o.removeClass("active");
      },
          g = t.move_with_handle_only ? l : o;

      g.on("movestart", _), g.on("move", w), g.on("moveend", m), t.move_slider_on_hover && (o.on("mouseenter", _), o.on("mousemove", w), o.on("mouseleave", m)), l.on("touchmove", function (e) {
        e.preventDefault();
      }), o.find("img").on("mousedown", function (e) {
        e.preventDefault();
      }), t.click_to_move && o.on("click", function (e) {
        p = o.offset().left, h = o.offset().top, u = s.width(), b = s.height(), a = v(e.pageX, e.pageY), d(a);
      }), e(window).trigger("resize.beforeafter");
    });
  };
}($);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js?d0be")))
...
/***/ 2:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./src/js/main.js ./src/js/vendor/jquery.event.move.min.js ./src/js/vendor/jquery.twentytwenty.min.js ./src/js/vendor/isotope.pkgd.min.js ./src/js/modules/hamburger-menu.js ./src/js/modules/accordion.js ./src/js/modules/before-and-after.js ./src/js/modules/file-handling.js ./src/js/modules/tabbing.js ./src/js/modules/gallery.js ./src/js/modules/plukkliste.js ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
